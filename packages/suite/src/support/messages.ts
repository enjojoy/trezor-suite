...
export default defineMessages({
    ...
    TR_ONBOARDING_TREZOR_WILL_DISPLAY_BACKUP: {
        defaultMessage:
            "Trezor will display your wallet backup. Write it down accurately and store securely. It's the only way recover your funds.",
        id: 'TR_ONBOARDING_TREZOR_WILL_DISPLAY_BACKUP',
    },
    TR_ONBOARDING_BACKUP_SUBHEADING: {
        defaultMessage:
            "Your wallet backup consists of a list of words generated by your Trezor. Write it down accurately and store securely. It's the only way recover your funds.",
    ...
    TR_DEVICE_SETTINGS_PASSPHRASE_DESC: {
        defaultMessage:
            "A passphrase adds a custom phrase (like a word, sentence, or string of characters) to your existing wallet backup, creating a hidden wallet. Each hidden wallet has its own passphrase. Your standard wallet remains accessible without a passphrase.\n\nDon't forget your passphrase. Unlike regular passwords, hidden wallet passphrases cannot be recovered. If you lose it, your funds will be permanently lost.",
